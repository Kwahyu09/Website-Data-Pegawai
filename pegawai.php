...
<html lang="en">
  ...
  <body>
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      >
                        ...
                        <?php
                          include "koneksi.php";
                          $sql="select * from pegawai order by nama desc";
                          ...
                          while ($data = mysqli_fetch_array($hasil)) {
                              ...
                              <tr>
                                  ...
                                  <td><?php echo $data["tgll_masuk"];   ?></td>
                                  <td><?php echo $data["jabatan"];   ?></td>
                                  <td style="display: flex; gap: 10px;">
                                      <a href="edit.php?id_pegawai=<?php echo htmlspecialchars($data['id_pegawai']); ?>" class="btn btn-primary" role="button"><i class="fas fa-edit"></i></a>
                                      <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>?id_pegawai=<?php echo $data['id_pegawai']; ?>" class="btn btn-danger ml-4" role="button"><i class="fas fa-times-circle"></i></a>
                                  </td>
                              </tr>
                              </tbody>
                              <?php
    ...
    <script>
    // Jika ada pesan sukses, tampilkan alert
